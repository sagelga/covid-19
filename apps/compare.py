...
@app.callback(
    Output("compare-insight-dashboard-1", "figure"),
    Output("compare-insight-dashboard-2", "figure"),
    Output("compare-insight-dashboard-3", "figure"),
    Output("compare-insight-dashboard-4", "figure"),
    Output("compare-insight-dashboard-5", "figure"),
    Output("compare-insight-dashboard-6", "figure"),
    [
